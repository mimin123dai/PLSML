...
config = {'pad_value': 0,
          ...
          'startepoch': 0, 'dataset_path': r'D:\daipeng\supervised-full\preprocessed_datasets', 'dataset_split': r"D:\daipeng\split_random_12b_0.2_0.8_1_2.pickle"}
...
if __name__ == '__main__':
	# _, model = get_model()
	with open(r"D:\daipeng\split_random_12b_0.2_0.8_1_2.pickle","rb") as datas:
