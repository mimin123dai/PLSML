...
def main():
    ...
    save_dir = os.path.join(r'D:\daipeng\MCF+reliable_label\code\train_MCF_airway\2024_4_15__semi_MCF+reliable_label_0.7', save_dir)
    ...
    net.load_state_dict(torch.load(r"D:\daipeng\MCF+reliable_label\code\train_MCF_airway\2023_3_24__semi_MCF+reliable_label\epoch_20.0000-mean_sensiti287.3551-dice90.4037")[
                            'state_dict'])
